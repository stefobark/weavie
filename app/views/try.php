      ...
      <div class="introBox"></div>
		   <div class="choose">
				<div class="container">
					<div class="row">
						<div class="col-md-3" >
							<div style="background: white; position:absolute; top:95px; z-index:10; border-radius:20px; padding:40px; -webkit-box-shadow: 2px 10px 20px 0px rgba(0,0,0,0.75); -moz-box-shadow: 2px 10px 20px 0px rgba(0,0,0,0.75); box-shadow: 2px 10px 20px 0px rgba(0,0,0,0.75);">
							  
								<h3 class="text-center"><img src="/img/started.png" style="width:100px"></h3>
								<br>
						...
						<div class="col-md-9">
							<div style="background:white; position:absolute; top:95px; border-radius: 20px; padding:40px; -webkit-box-shadow: 2px 10px 20px 0px rgba(0,0,0,0.75); -moz-box-shadow: 2px 10px 20px 0px rgba(0,0,0,0.75); box-shadow: 2px 10px 20px 0px rgba(0,0,0,0.75);">
