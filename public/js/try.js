...
//for pumping out the weaveBox
	...
	for (i = 0; i < numWefts; i++) {
		...
		$(".weaveBox").append('<div class="weft' + i + '" style="position:absolute; width:100%; height: 15px; top:' + weaveBoxTop + 'px;"></div>');
		$(".weftColorGrid").append('<button class="pickWeft' + i + 'Color" style="position:absolute;  top:' + weaveBoxTop + 'px; width:15px; height:15px;"></button>')
	...
	for (i = 0; i < numWarps; i++) { 
			...
			$(".weaveBox").append('<div class="warp' + i + ' ' + pass + '" style="position:absolute; left:' + warpLeft + 'px; height:15px; width:15px;" ></div>');			
			$(".warpColorGrid").append('<button class="pickWarp' + i + 'Color" style="position:absolute;top:0; left:' + warpLeft + 'px; width:15px; height:15px;"></button>')
	}
...
//mangage the treadling
	...
	$(".treadleGridCol1").click(function(){
		...
		$('#' + parent).children().removeClass('activeButton');
		$('.warp' + findWarp).children().removeClass("above");
