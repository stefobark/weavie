    ...
    function setWarpColor(warpColorChosen, rgbColor) {
        $(".warpColorButton").click(function() {
           ...
           WIF["WARP COLORS"][warpID] = warpColorIndex;
		    ...
		    $('body').append('<input class="btn btn-default" id="disableIt" type="submit" value="Save Pattern Image" onclick="capture();"  style="position:fixed; top:25px; right:400px;" /><form method="POST" enctype="multipart/form-data" action="/save" id="myForm"><input type="hidden" name="img_val" id="img_val" value="" />');
